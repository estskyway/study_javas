...
import cars.AnyStatement;

public class ConnectDBsWithMethod_1  {
    public static void main(String[] args) {
        try {
            ...
            AnyStatement anyStatement = new AnyStatement();
            ResultSet resultSet = anyStatement.selectStatements(statement, query);
